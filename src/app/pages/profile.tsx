...
export function Profile() {
  ...
  useEffect(() => {
    ...
    if (stored) {
      ...
      const mostCommon = Object.entries(moodCounts).reduce((max, [mood, count]) => 
        count > max.count ? { mood: mood as Mood, count } : max
      ...
      <div className="flex-1 p-8 flex items-center justify-center">
        ...
        >
          <div className="flex flex-col items-center mb-8">
            ...
            <h1 className="text-2xl" style={{ color: '#4A3F35' }}>
              {name}
            </h1>
          ...
          <div 
            ...
            style={{ borderColor: '#F8C8DC' }}
          >
            <h2 className="text-lg mb-4" style={{ color: '#4A3F35' }}>
              Journal Stats
            </h2>
            
            <div className="space-y-3">
              <div className="flex justify-between items-center">
                <span className="opacity-70" style={{ color: '#4A3F35' }}>
                  Total Entries
                </span>
                <span style={{ color: '#4A3F35' }}>
                  {stats.totalEntries}
              ...
              <div className="flex justify-between items-center">
                ...
                <div 
                  ...
                  style={{ 
                    backgroundColor: moodConfig[stats.mostCommonMood].color,
                    color: '#4A3F35'
                  }}
                >
